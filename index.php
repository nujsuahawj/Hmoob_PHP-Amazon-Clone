...
<body>
    ...
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v3.3&appId=1093529534141527&autoLogAppEvents=1"></script>
	...
	<div class="navbar navbar-default navbar-fixed-top" id="topnav">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> <span class="badge"></span>	</a>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="get_cat"></div>
				...
				<div>
					<div class="nav nav-pills nav-stacked">
						<li class="active"><a href="#"><h4>Short</h4></a></li>
						<li><a href="#" id='price_sort'>Price</a> </li>
						<li> <a href="#" id='pop_sort'>Popularity</a></li>
					</div>
...
<p> Make By <a href="#">Vivek Kumar Pandey</a></p>
</footer></div>
<?php 
