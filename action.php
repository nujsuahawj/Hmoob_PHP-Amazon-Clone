				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<a href='#' class='imageproduct' pid='$pro_id'>
									<img src='admin/product_images/$img' style='width:200px; height:250px;' >
								</a>
								</div>
		...
		while($row=mysqli_fetch_array($run_query)){
			$pro_id=$row['product_id'];
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								<div class='panel-heading'>$title</div>
								<div class='panel-body' class='imageproduct' pid='$pro_id'><img src='admin/product_images/$img' style='width:200px; height:250px;'></div>
								<div class='panel-heading'>Rs $price
		...
		while($row=mysqli_fetch_array($run_query))
		{
			...
			if(isset($_POST['cartmenu']))
			{
				...
				<div class='row'>
									...
									<div class='col-md-3'><img src='admin/product_images/$product_image' width='60px' height='60px'></div>
			...
			else
			{
				echo "
					<div class='row'>
						...
						<div class='col-md-2'><img src='admin/product_images/$product_image' width='60px' height='60px'></div>
		...
		echo "
				<div class='row'>
					<div class='col-md-6 pull-right'>
						<img src='admin/product_images/$image' style='width:250px;height:300px;'>
					</div>
					<div class='col-md-6'>
					...
					<iframe src='https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&layout=button_count&size=small&appId=452711395175318&width=88&height=20' width='88' height='20' style='border:none;overflow:hidden' scrolling='no' frameborder='0' allowTransparency='true' allow='encrypted-media'></iframe>
				</div>
		";
	}
